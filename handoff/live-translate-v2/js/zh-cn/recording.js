...
/* ════════ Language selector ════════ */
var hints = {
  zh: '选择语言，点击开始收音<br>即时翻译英语内容。',
  es: 'Selecciona el idioma y toca<br>iniciar para traducir.'
};
var startLabels = { zh: '开始收音', es: 'Iniciar' };
...
function buildSummary() {
  ...
  if (savedWords.length === 0) {
    list.innerHTML = '<div style="text-align:center;padding:32px 0;color:#94a3b8;font-size:14px;">' +
      (currentLang === 'zh' ? '本次未保存任何单字' : 'No se guardaron palabras') + '</div>';
    return;
  }
