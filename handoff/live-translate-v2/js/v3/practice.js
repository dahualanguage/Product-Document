...
function checkPracSpelling(word) {
  ...
  if (val === w) {
    ...
    pracResults.push({ word: word, type: 'spelling', correct: true, userAnswer: val });
    pracCorrect++;
    goNextAfterSpelling(300);
    return;
  }
  ...
  if (pracAttempts === 1) {
    ...
    pracResults.push({ word: word, type: 'spelling', correct: false, userAnswer: val });
