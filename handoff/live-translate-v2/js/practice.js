...
function buildSpellingQ(area, word) {
  ...
  area.innerHTML =
    ...
    '<div class="prac-card">' +
      ...
      '<input class="prac-input" id="prac-input" type="text" placeholder="輸入英文拼寫" autocomplete="off" autocapitalize="off">' +
...
function showPracResults() {
  ...
  html += '<div class="results-stat"><div class="results-stat-val correct">' + pracCorrect + '</div><div class="results-stat-label">答對</div></div>';
  html += '<div class="results-stat"><div class="results-stat-val wrong">' + wrongCount + '</div><div class="results-stat-label">答錯</div></div>';
  html += '</div>';
  html += '</div>';
  ...
  html += '<button class="results-btn-text" onclick="backFromResults()"><span class="material-icons-round">arrow_back</span> 回單字庫</button>';
  html += '</div>';
