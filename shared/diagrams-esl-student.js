...
window.ESL_STUDENT = {
  ...
  studentPracticeFlow: `flowchart TD
    ...
    START --> EntryA["🏠 Practice Shortcut Button<br/>e.g. Spelling / MC / Mirroring / Practice All"]
    START --> EntryB["📋 Recommended Card<br/>Challenge of the Day / Focus Subject Words<br/>Newly Added / Almost There"]

    EntryA --> POPUP["Practice Setup Popup<br/>(single page, stays on homepage)"]
    EntryB --> POPUP

    POPUP --> CONFIG["Configure visible sections<br/>Subject / Category / Practice Way / Duration<br/>(conditional based on entry point)"]
